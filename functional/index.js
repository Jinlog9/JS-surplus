...
// curry 함수 => 함수를 받아서 함수를 리턴하는데, 그렇게 리턴된 함수를 실행되었을때..
// 인자가 2개이상이라면 받아둔 함수를 즉시 실행하고, 인자가 2개보다 작다면 다시 한 번 함수를 리턴.
// => 그 이후에 들어올 값들을 받아보고 그렇게 받아서 그때는 함수(미리 받았던 a, 전달한 함수)를 실행한다.
